...
export class UserRoleEntity1703512053277 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "role_name_uc" ON "role" ("name") WHERE (deleted_at IS NULL)`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "user_email_uc" ON "user" ("email") WHERE (deleted_at IS NULL)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."user_email_uc"`);
        await queryRunner.query(`DROP TABLE "user"`);
        await queryRunner.query(`DROP INDEX "public"."role_name_uc"`);
